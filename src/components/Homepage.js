            ...
            <AppWrapper>
                <Grid container spacing={0} alignItems="stretch" style={{minHeight: "calc(100vh - 48px)"}}>
                    ...
                    <TextWrapper>
                        ...
                        <BioParagraph>
                            Currently spending my time learning tennis and continuously starting side projects with new web technologies <StyledA rel="noopener noreferrer" target="_blank" href="https://github.com/lichliter/Portfolio-2018">like this portfolio</StyledA>!
                        </BioParagraph>          
